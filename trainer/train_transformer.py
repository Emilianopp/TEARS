...
def train_model():
    ...
    train_fun = train_bpr if args.neg_sample else train_softmax
    ...
    for e in (pbar := tqdm(range(args.epochs))):
        ...
        val_recall, val_ndcg = train_fun(args, rec_dataloader, model, prompt_embeddings, optimizer, scheduler,prompts, val_items)
