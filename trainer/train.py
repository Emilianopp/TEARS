...
def train_fun(rank, world_size, args):
    ...
    if args.eval_control:
        ...
        large_change_evaluator = LargeScaleEvaluator(
            model, item_title_dict, item_genre_dict, tokenizer, 0, args, alpha=0.5, split='')
        ...
        if e % 1 == 0:
            ...
            if args.eval_control:
                if world_size > 1:
                    ...
                    delta_up, delta_down = large_change_evaluator.evaluate(
                        val_dataloader, prompts, 20, rank=rank)
